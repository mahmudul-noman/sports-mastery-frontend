            ...
            <div className="navbar z-10 bg-base-100 py-6">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 space-y-3 z-10 shadow bg-base-100 rounded-box w-52">
                ...
                <div className="md:navbar-end space-x-3">
