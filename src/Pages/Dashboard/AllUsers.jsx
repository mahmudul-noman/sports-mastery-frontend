                    ...
                    <tbody className="text-center">
                        {
                            users.map((user, index) =>
                                <tr key={user._id}>
                                    ...
                                    <td>{
                                        user.role === 'instructor' ? <button className="btn btn-outline border-purple-700 font-extrabold text-green-600 hover:bg-purple-600 hover:text-white border-0 border-b-2 border-t-2"><FaCheckCircle className="text-xl text-green-700"></FaCheckCircle>Instructor</button> :
                                            <button className="btn btn-outline border-purple-700 text-sky-600 hover:bg-purple-600 hover:text-white border-0 border-b-2 border-t-2">Make Instructor</button>
                                    }
                                    </td>
                                    <td>{
                                        user.role === 'admin' ? <button className="btn btn-outline border-purple-700 font-extrabold text-green-600 hover:bg-purple-600 hover:text-white border-0 border-b-2 border-t-2"><FaCheckCircle className="text-xl text-green-700"></FaCheckCircle>Admin</button> :
                                            <button className="btn btn-outline border-purple-700 text-sky-600 hover:bg-purple-600 hover:text-white border-0 border-b-2 border-t-2">Make Admin</button>
                                    }
                                    </td>
                                </tr>)
                        }
